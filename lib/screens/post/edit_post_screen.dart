...
class _EditPostScreenState extends State<EditPostScreen> {
  ...
  void _initializeWithExistingData() {
    // Pre-populate fields with existing post data
    _titleController.text = widget.post.title;
    _descriptionController.text = widget.post.description;
    _imageUrl = widget.post.imageUrl;
    _selectedExpiry = widget.post.expiry;
    _selectedDietaryTags = List.from(widget.post.dietaryTags);
    _selectedLocation = widget.post.location;
    _selectedAddress = widget.post.address;
    _locationController.text = widget.post.address;
  }
  ...
  Future<void> _updatePost() async {
    ...
    try {
      final user = FirebaseAuth.instance.currentUser;
      if (user == null) {
        _showSnackBar('You must be logged in to update posts', isError: true);
      ...
      _showSnackBar('Failed to update post: $e', isError: true);
    } finally {
      setState(() => _isLoading = false);
    }
  }
