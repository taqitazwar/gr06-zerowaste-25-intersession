...
import '../claim/claims_screen.dart';
                        ...
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) => RatingScreen(
                              targetUserId: _userModel!.uid,
                              targetUserName: _userModel!.name,
                            ),
                          ),
                        );
                      }
        ...
        child: Column(
          ...
          children: [
            ...
            ListTile(
              ...
              subtitle: const Text('View and manage your claims'),
              trailing: const Icon(Icons.chevron_right),
              onTap: () {
                Navigator.push(
                  context,
            ...
            ListTile(
              ...
              subtitle: const Text('View and manage your ratings'),
              trailing: const Icon(Icons.chevron_right),
              onTap: () {
                if (_userModel != null) {
                  Navigator.push(
